...
\title{Inference of Stacked Sparse Autoencoder}
%
%
...
\author{Shengke Xue, 11531015
\thanks{Shengke Xue is a PhD.~candidate with the College of Information Science and Electronic Engineering,~Zhejiang University,~Hangzhou,~China.~e-mail: xueshengke@zju.edu.cn.}
...
\input{sections/Derivation_of_Autoencoder}

\input{sections/Stacked_Autoencoder}
